...
public class Pokedex {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3 -> System.out.println("¡Hasta la próxima, entrenador Pokémon!");
    ...
    private static void elegirPokemon() {
        ...
        try {
            ...
            String habilidadElegida = pokemon.getAbilities().get(habIndex).getAbility().getName();

            // Elegir movimiento
            System.out.print("Elige un movimiento por número: ");
            int movIndex = Integer.parseInt(scanner.nextLine()) - 1;
            String movimientoElegido = pokemon.getMoves().get(movIndex).getMove().getName();
